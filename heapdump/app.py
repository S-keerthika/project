...
def search_password_values(strings_output):
    ...
    for line in strings_output.splitlines():
        ...
        for match in matches:
            ...
            password_values.add((username, match)) 
...
def search_client_ids(strings_output):
    ...
    redirect_uri_pattern = re.compile(r'redirect_uri\s*=\s*([^&\s]+)', re.IGNORECASE) 
...
def search_api_password(strings_output):
    ...
    for line in strings_output.splitlines(): 
        ...
        for api_password in api_password_matches:
            ...
            api_password_values.add((api_username, api_password, api_client_secret, api_base_url, api_client_id))  
